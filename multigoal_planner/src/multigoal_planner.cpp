...
bool MultiGoalPlanner::makePlans(const humans_nav::map_pose &starts,
...
bool MultiGoalPlanner::makePlans(const humans_nav::map_pose &starts,
  ...
  humans_nav::map_pose_vector combined_plans;
  for (auto start_kv : starts) {
    ...
    humans_nav::pose_vectors plan_vector;
    humans_nav::pose_vector combined_plan;
...
void MultiGoalPlanner::publishPlans(humans_nav::map_pose_vector &plans) {
