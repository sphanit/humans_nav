...
class OptiTrackHuman():
    ...
    def OptiTrackCB(self, msg): 
        if(msg.pos):
            self.pos.position.x = copy.copy(msg.pos[0].x)+6.4
            self.pos.position.y = copy.copy(msg.pos[0].y)+3.2
            self.pos.position.z = 0.0#copy.copy(msg.pos[0].z)

            self.pos.orientation.x = 0.0#copy.copy(msg.att[0].qx)
            self.pos.orientation.y = 0.0#copy.copy(msg.att[0].qy)
